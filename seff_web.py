...
<head>
  ...
  <style>
    ...
    input,button{font:inherit;padding:.5rem}.metrics{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:1rem;margin-top:1.5rem}
    .card{border:1px solid #ddd;border-radius:6px;padding:1rem}.value{font-size:2rem;font-weight:600;margin-top:.5rem}
